...
- When asked to update on GitHub, merge into `main` instead of leaving a draft PR unless explicitly told otherwise.
...
- `docs/ADB_WIRELESS_DEBUGGING.md`: Use when Android wireless debugging/ADB auto-connect fails or the device shows a different debug port.
